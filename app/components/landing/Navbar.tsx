      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            >
              <div className="relative w-12 h-12 rounded-2xl p-2 shadow-sm group-hover:shadow-md transition-all duration-300">
                <Image
                  src="/images/logo.png"
                ...
                {isAuthenticated ? (
                  <>
                    ...
                    <button
                      ...
                      className="w-full text-left py-3 px-4 text-red-600 font-medium hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-300"
                    >
                      Logout
                    </button>
                  </>
