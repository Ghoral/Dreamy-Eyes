      ...
      {startPage > 1 && (
        <>
          <button
            ...
            className="px-4 py-2 rounded-lg bg-white text-secondary-700 hover:bg-secondary-50 border border-secondary-200"
          >
            1
          </button>
          {startPage > 2 && (
          ...
          <>
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-secondary-800">
                {type === "latest_arrival" && "Latest Arrivals"}
                {type === "top_seller" && "Best Sellers"}
                {type === "best_reviewed" && "Top Reviewed"}
              </h2>
