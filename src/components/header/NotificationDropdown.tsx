          ...
          {loading ? (
            ...
            notifications.map((notification) => (
              <li key={notification.id}>
                ...
                >
                  <span className="relative flex items-center justify-center w-10 h-10 bg-orange-100 rounded-full dark:bg-orange-900/20">
                    <svg
                  ...
                  <span className="flex-1 block">
                    ...
                    <span className="block mb-2 text-gray-500 text-theme-sm dark:text-gray-400">
                      {notification.body}
                    </span>
